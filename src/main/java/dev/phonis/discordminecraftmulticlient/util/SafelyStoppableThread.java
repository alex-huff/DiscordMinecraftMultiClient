...
public
class SafelyStoppableThread extends Thread
{
	 ...
	 */
	public
	SafelyStoppableThread(Runnable task)
	{
		super(task);
	}
	...
	public
	void safelyStop() throws InterruptedException
	{
		this.interrupt();
	 ...
	 */
	public static
	void stopAll(SafelyStoppableThread... threads) throws InterruptedException
	{
