...
public class Authenticator {
    ...
    public static SessionToken getOrRefreshSession(SessionToken sessionToken, String username, String password) throws InterruptedException, ExecutionException {
        return Authenticator.getSessionResolver(sessionToken, username, password).get();
    }

    private static SessionResolver getSessionResolver(SessionToken sessionToken, String username, String password) throws InterruptedException {
